...
export function LoginPage() {
  ...
  if (isAuthenticated) {
    const from = location.state?.from?.pathname || (selectedPortal === 'admin' ? '/admin/dashboard' : '/customer-portal/dashboard');
  ...
  if (!portal) {
    return <div className="liquid-login-bg min-h-screen relative overflow-hidden">
              ...
              <TabsContent value="customer-portal" className="mt-4">
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input id="email" type="email" placeholder="Enter your email" value={credentials.email} onChange={handleInputChange('email')} required disabled={isSubmitting} />
                  </div>

                  <div className="space-y-2">
                    <Label htmlFor="password">Password</Label>
                    <div className="relative">
                      <Input id="password" type={showPassword ? 'text' : 'password'} placeholder="Enter your password" value={credentials.password} onChange={handleInputChange('password')} required disabled={isSubmitting} className="pr-10" />
                  ...
                  <Button type="submit" className="w-full" disabled={isSubmitting || isLoading}>
                    {isSubmitting ? <div className="flex items-center gap-2">
                        ...
                        Signing in...
                      </div> : 'Sign In to Customer Portal'}
                  </Button>
                </form>
              ...
              <TabsContent value="admin" className="mt-4">
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input id="admin-email" type="email" placeholder="Enter your email" value={credentials.email} onChange={handleInputChange('email')} required disabled={isSubmitting} />
                  </div>

                  <div className="space-y-2">
                    <Label htmlFor="admin-password">Password</Label>
                    <div className="relative">
                      <Input id="admin-password" type={showPassword ? 'text' : 'password'} placeholder="Enter your password" value={credentials.password} onChange={handleInputChange('password')} required disabled={isSubmitting} className="pr-10" />
                      <Button type="button" variant="ghost" size="sm" className="absolute right-0 top-0 h-full px-3 py-2 hover:bg-transparent" onClick={() => setShowPassword(!showPassword)} disabled={isSubmitting}>
                        {showPassword ? <EyeOff className="h-4 w-4 text-muted-foreground" /> : <Eye className="h-4 w-4 text-muted-foreground" />}
                      </Button>
                    </div>
        ...
        <div className="lg:hidden min-h-screen flex items-center justify-center p-4 relative">
          ...
          <Card className="w-full max-w-md glass-card relative z-10">
            ...
            <CardHeader className="text-center space-y-4">
              ...
              <div>
                <CardTitle className="text-2xl font-bold">BSL Portal Login</CardTitle>
                <CardDescription>
                  Select your portal and sign in
                </CardDescription>
              </div>
      ...
      <div className="hidden lg:flex min-h-screen">
        ...
        <CardContent>
          ...
          <div className="mt-6 text-center text-sm text-muted-foreground">
            <p>Demo Credentials:</p>
            <div className="mt-2 space-y-1">
              {isAdminLogin ? <p><strong>Admin:</strong> admin@pkbsl.com / password</p> : <>
                  <p><strong>Shell:</strong> shell@admin.com / password</p>
                  <p><strong>Siemens:</strong> siemens@admin.com / password</p>
                  <p><strong>UniLever:</strong> unilever@admin.com / password</p>
                </>}
